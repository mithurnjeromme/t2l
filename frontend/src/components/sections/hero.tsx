      ...
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-8 md:gap-16 items-center">
        <div className="text-foreground z-10 relative">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <Button
              size="lg"
              className="rounded-full bg-[#DF9C49] hover:bg-[#DF9C49]/90 text-white font-semibold px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg font-body w-full sm:w-auto"
            ...
            <Link href="/lawgpt">
              <Button
                size="lg"
                className="rounded-full bg-[#17726E] hover:bg-[#17726E]/90 text-white font-semibold px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg font-body w-full sm:w-auto"
              >
                Try LawGPT
              </Button>
            </Link>
