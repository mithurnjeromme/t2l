...
const Footer = () => {
  return (
    <footer
      id="contact"
      className="bg-card dark:bg-[#191919] text-foreground dark:text-white py-12 rounded-t-3xl mt-16 border-t border-border/20"
    >
      <div className="container mx-auto px-6 relative">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <h2 className="text-3xl font-headline font-bold text-foreground dark:text-white mb-6 leading-tight">
          ...
          <div className="lg:col-span-1">
            <h3 className="font-headline font-semibold text-xl mb-6 text-foreground dark:text-white">
              Links
            </h3>
            <ul className="space-y-3 text-muted-foreground dark:text-white/70 font-body">
              <li>
                <Link
                  href="#about"
        ...
        {/* Copyright */}
        <div className="mt-12 border-t border-border/30 dark:border-white/20 pt-6 text-center text-muted-foreground dark:text-white/50">
          <p className="font-body">
            Copyright &copy; {new Date().getFullYear()} Turn2Law. All Rights
            Reserved.
          </p>
        </div>
      </div>
