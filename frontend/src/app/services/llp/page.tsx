    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="grid grid-cols-2 gap-6 mt-12">
                <div>
                  <div className="text-3xl font-bold text-primary">₹11,999</div>
          ...
          <div className="grid md:grid-cols-5 gap-4">
            {[
              ...
              <div key={idx} className="relative">
                ...
                {idx < 4 && (
                  <ArrowRight className="hidden md:block absolute top-1/2 -right-2 -translate-y-1/2 w-5 h-5 text-primary" />
                )}
              </div>
            ))}
          </div>
      ...
      <section className="py-16 px-6 bg-primary text-primary-foreground">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Register Your LLP?</h2>
          <p className="text-xl mb-8 text-primary-foreground/90">Get the best of both worlds - partnership flexibility with limited liability protection</p>
