    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="grid grid-cols-2 gap-6 mt-12">
                ...
                <div>
                  <div className="text-3xl font-bold text-primary">1 Person</div>
      ...
      <section className="py-16 px-6 bg-primary text-primary-foreground">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Start Your OPC?</h2>
          <p className="text-xl mb-8 text-primary-foreground/90">Perfect for solo entrepreneurs who want limited liability protection</p>
