                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-secondary mt-1 font-body">+0% from last month</p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-headline font-semibold text-foreground">--</p>
                      <p className="text-xs text-secondary mt-1">Case resolution</p>
                    </div>
                    <div className="w-12 h-12 bg-secondary/20 rounded-2xl flex items-center justify-center">
